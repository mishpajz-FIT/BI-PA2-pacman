...
GameFileLoader::GameFileLoader(const std::string & filePath) : FileLoader(filePath) { }

Game GameFileLoader::loadGame() {
    ...
    return Game(values[0], values[1], values[2], values[3], values[4], values[5], values[6], values[7]);
}